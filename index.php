  ...
  <body>
    <div class="header">
      <div class="container">
        ...
        <div class="row">
          <div class="col-2">
            <h1>
            La Fuerza está contigo <br />
            joven Skywalker!!!
            </h1>
            <p>
            Yo soy tu padre <?php if (isset($_SESSION['logueado'])&& isset($_SESSION['username'])){
                  $userLogueado=$_SESSION['username'];
                  $userName=$userLogueado['nombre'];
                  echo " $userName ";
            ...
            <a href="account.php" class="btn">Unete al lado oscuro &#8594;</a>
          </div>
          <div class="col-2">
            <img src="images/nerd.png" alt="" />
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="small-container">
      ...
      <?php foreach($productos as $producto) {?>
        <div class="col-4">
        <?php
        $imagenesFn= array_filter($imagenes, function($val,$key)use ($producto)  {
          return $val['productos_id']==$producto['id'];
        }, ARRAY_FILTER_USE_BOTH);
        $imgAsociada=array_shift($imagenesFn);
         ?>
        <img src="images/<?php echo $imgAsociada['url'];?>" alt=""/>
